...
**Дата:** 2024 - 2025             <br>
**Проект:** Сервис формирования пояснительной записки       <br>
...
**Заказчик:** СОГАЗ  
**Роль:** DevOps инженер  
**Инструменты и технологии:** Docker, GitLab, IIS, MSSQL, PRTG, ELK, REST API, Powershell, ActiveMQ, Windows, Linux  
**Задачи:**
