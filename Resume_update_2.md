...
**Проект:** Импортозамещение. Микросервис очередей и картотеки платежных документов                            <br>
**Заказчик:** ВТБ (банк)  <br>
...
**Задачи:**  <br>
*   Проектирование и согласование бизнес-процессов
*   Проектирование интеграционных процессов и интерфейсов
*   Документирование
*   Согласование тестовых сценариев
**Инструменты:** (указать конкретные инструменты) <br>
